...
public extension UIView {
    ...
    ///
    /// - Parameters:
    ///   - format: Visual Format language
    ///   - views: Array of views which will be accessed starting with index 0 (example: [v0], [v1], [v2]..)

    public func addConstraintsWith (format: String, views: UIView...) {
    ...
    // SwifterSwift: Add anchors from any side of the current view into the specified anchors.
    ///
    /// - Parameters:
    ...
    // SwifterSwift: Add anchors from any side of the current view into the specified anchors and returns the newly added constraints if not nil
    ///
    /// - Parameters:
    ///   - top: current view's top anchor will be anchored into the specified anchor
    ///   - left: current view's left anchor will be anchored into the specified anchor
