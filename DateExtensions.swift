...
//  SwiftyExtensions
//
//  Created by Omar Albeik on 8/3/16.
...
extension Date {
    ...
    var nanosecond: Int {
        ...
        set {
            self = calendar.date(bySetting: .nanosecond, value: newValue, of: self) ?? self
        }
    }
    ...
    var weekday: Int {
        ...
        set {
            self = calendar.date(bySetting: .weekday, value: newValue, of: self) ?? self
        }
    }
    ...
    var weekOfMonth: Int {
        ...
        set {
            self = calendar.date(bySetting: .weekOfMonth, value: newValue, of: self) ?? self
        }
    }
    ...
    var weekOfYear: Int {
        ...
        set {
            self = calendar.date(bySetting: .weekOfYear, value: newValue, of: self) ?? self
        }
    }
    ...
    var era: Int {
        ...
        set {
            self = calendar.date(bySetting: .era, value: newValue, of: self) ?? self
        }
    }
    ...
    var quarter: Int {
        ...
        set {
            self = calendar.date(bySetting: .quarter, value: newValue, of: self) ?? self
        }
    }
    ...
    /// Add nanoseconds to a Date
    func add(nanoseconds: Int) -> Date {
        return calendar.date(byAdding: .nanosecond, value: nanoseconds, to: self) ?? self
    }
