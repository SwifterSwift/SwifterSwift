...
extension LocaleExtensionsTests {
    ...
    static let __allTests__LocaleExtensionsTests = [
        ("testIs12HourTimeFormat", testIs12HourTimeFormat),
        ("testPosix", testPosix),
    ]
}
...
extension NSRegularExpressionExtensionsTests {
    ...
    static let __allTests__NSRegularExpressionExtensionsTests = [
        ...
        ("testRangeOfFirstMatch", testRangeOfFirstMatch),
        ("testReplaceMatches", testReplaceMatches),
        ("testStringByReplacingMatches", testStringByReplacingMatches),
    ]
}
