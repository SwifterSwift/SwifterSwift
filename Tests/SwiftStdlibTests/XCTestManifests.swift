...
extension DecodableExtensionsTests {
    // DO NOT MODIFY: This is autogenerated, use:
    //   `swift test --generate-linuxmain`
    // to regenerate.
    static let __allTests__DecodableExtensionsTests = [
        ("testDecodeModel", testDecodeModel),
        ("testDecodeModelInvalidData", testDecodeModelInvalidData),
    ]
}
...
extension DictionaryExtensionsTests {
    ...
    static let __allTests__DictionaryExtensionsTests = [
        ...
        ("testInitGroupedByKeyPath", testInitGroupedByKeyPath),
...
extension KeyedDecodingContainerTests {
    ...
    static let __allTests__KeyedDecodingContainerTests = [
        ("testDecodeBoolAsIntOrStringDataAsBoolSuccessful", testDecodeBoolAsIntOrStringDataAsBoolSuccessful),
        ("testDecodeBoolAsIntOrStringDataAsIntSuccessful", testDecodeBoolAsIntOrStringDataAsIntSuccessful),
        ("testDecodeBoolAsIntOrStringDataAsStringSuccessful", testDecodeBoolAsIntOrStringDataAsStringSuccessful),
        ("testDecodeBoolAsIntOrStringIfPresentSuccessful", testDecodeBoolAsIntOrStringIfPresentSuccessful),
        ("testDecodeBoolAsIntOrStringThrowsError", testDecodeBoolAsIntOrStringThrowsError),
    ]
}

extension MutableCollectionTests {
    // DO NOT MODIFY: This is autogenerated, use:
    //   `swift test --generate-linuxmain`
    // to regenerate.
    static let __allTests__MutableCollectionTests = [
        ("testAssignToAll", testAssignToAll),
        ("testKeyPathSort", testKeyPathSort),
        ("testSortByThreeKeyPaths", testSortByThreeKeyPaths),
        ("testSortByTwoKeyPaths", testSortByTwoKeyPaths),
    ]
}
...
extension RangeReplaceableCollectionTests {
    ...
    static let __allTests__RangeReplaceableCollectionTests = [
        ...
        ("testRemoveDuplicatesUsingKeyPathEquatable", testRemoveDuplicatesUsingKeyPathEquatable),
        ("testRemoveDuplicatesUsingKeyPathHashable", testRemoveDuplicatesUsingKeyPathHashable),
...
extension SequenceExtensionsTests {
    ...
    static let __allTests__SequenceExtensionsTests = [
        ...
        ("testFilterByKeyPath", testFilterByKeyPath),
        ...
        ("testSortedByThreeKeyPaths", testSortedByThreeKeyPaths),
        ("testSortedByTwoKeyPaths", testSortedByTwoKeyPaths),
        ("testSum", testSum),
        ("testWithoutDuplicates", testWithoutDuplicates),
    ]
}
...
public func __allTests() -> [XCTestCaseEntry] {
    return [
        ...
        testCase(DecodableExtensionsTests.__allTests__DecodableExtensionsTests),
        ...
        testCase(MutableCollectionTests.__allTests__MutableCollectionTests),
