// SKProductTests.swift - Copyright 2020 SwifterSwift
...
final class SKProductTests: XCTestCase {
    func testLocalizedPrice() {
        let usMockedProduct = SKProduct(identifier: "com.swifterswift.usmockedproduct", price: "10.50",
                                        priceLocale: Locale(identifier: "en_US"))

        XCTAssertEqual(usMockedProduct.localizedPrice, "$10.50")

        let trMockedProduct = SKProduct(identifier: "com.swifterswift.trmockedproduct", price: "7.50",
                                        priceLocale: Locale(identifier: "tr_TR"))

        XCTAssertEqual(trMockedProduct.localizedPrice, "₺7,50")

        let noMockedProduct = SKProduct(identifier: "com.swifterswift.nomockedproduct", price: "100.00",
                                        priceLocale: Locale(identifier: "nb_NO"))

        XCTAssertEqual(noMockedProduct.localizedPrice, "kr 100,00")

        let frMockedProduct = SKProduct(identifier: "com.swifterswift.frmockedproduct", price: "10.00",
