...
extension String {
    ...
    ///
    @available(*, deprecated: 4.0.2, message: "This extension is deprecated, please use .count instead.")
    ...
    @available(*, deprecated: 4.0.2, message: "Please use string[safe: i] instead.")
    ...
    @available(*, deprecated: 4.0.2, message: "Please use string[safe: start..<end] instead.")
    ...
    @available(*, deprecated: 4.0.2, message: "Please use string.index(of: Character) or string.range(of: StringProtocol) instead.")
    ...
    @available(*, deprecated: 4.0.2, message: "Please use string.split(separator: Character) instead.")
    ...
    @available(*, deprecated: 4.0.2, message: "Please use String(str.reversed()) or reversed() -> ReversedCollection<String> instead.")
