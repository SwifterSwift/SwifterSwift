...
- **Date**
  - Added `isLeapYear` to check whether or not the year is a leap year. [#605](https://github.com/SwifterSwift/SwifterSwift/pull/605) by [dylancfe15](https://github.com/dylancfe15)
