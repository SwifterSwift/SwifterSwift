...
### Added
- **UIImageView**
  - Added `removeBlur` method for removing the applied blur effect from the image view. [#1158](https://github.com/SwifterSwift/SwifterSwift/pull/1159) by [regi93](https://github.com/regi93)
