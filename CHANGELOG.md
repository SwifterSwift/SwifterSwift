...
- **URLRequest**
  ...
  - Added `headers()` to duplicate the request and set headers with key and value from a dictionary. [#1135](https://github.com/SwifterSwift/SwifterSwift/pull/1135) by [Ricardo Rauber](https://github.com/ricardorauber)
- **URLSession**
