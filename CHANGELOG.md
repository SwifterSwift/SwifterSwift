...
- **UIView**
  ...
  - Added `fillToSuperviewSafeArea(viewController:)` which anchors view to superview's safe area (or to bottomLayoutGuide and topLayoutGuide on pre iOS 11). [#539](https://github.com/SwifterSwift/SwifterSwift/pull/539) by [viktart](https://github.com/viktart)
- **UIViewController**
