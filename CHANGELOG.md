...
- **Measurement**
  ...
  - **UITextField**
    - Added `addToolbar((items:height:)` extension to add tool bar to the UITextField. [#954](https://github.com/SwifterSwift/SwifterSwift/pull/954) by [Randhir Kumar](https://github.com/randhirkumar65)
