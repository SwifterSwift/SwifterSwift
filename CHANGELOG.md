...
### Added
- **FileManager**
- Added `encode(_:using:outputFormat:to:attributes:)` method to save Encodable object to file at provided URL using PropertyListEncoder. [#603](https://github.com/SwifterSwift/SwifterSwift/pull/603) by [AlexeiGitH](https://github.com/AlexeiGitH)
- **Date**
