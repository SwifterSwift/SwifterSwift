...
- **String**:
  ...
  - Added `width(withConstraintedHeight height: CGFloat, _ font: UIFont?)` for calculating width of a string [#1125](https://github.com/SwifterSwift/SwifterSwift/pull/1125) by [siamak](https://github.com/siamakrostami)
- **DispatchQueue**:
