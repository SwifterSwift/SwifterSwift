...
### Added
- **Array**
 - Added `duplicatedElements() -> [Element]` get duplicated elements from an array. [#604](https://github.com/SwifterSwift/SwifterSwift/pull/604) by [dylancfe15](https://github.com/dylancfe15)
- **Date**
