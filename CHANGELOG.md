...
- **Array**
  - Added `init(numberOfElements:element:)` initializer for creating an array of a given size with a closure. [#1051](https://github.com/SwifterSwift/SwifterSwift/pull/1051) by [viktart](https://github.com/viktart)
### Fixed
 - **Digest**
