...
### Added
- **Date**
  - Added `isLeapYear` to check whether or not the year is a leap year. [#608](https://github.com/SwifterSwift/SwifterSwift/pull/608) by [dylancfe15](https://github.com/dylancfe15)
