...
### Added
- **Encodable**
- Added  `encode(_:to:)` method to save Encodable object to file at provided URL. [#597](https://github.com/SwifterSwift/SwifterSwift/pull/597) by [AlexeiGitH](https://github.com/AlexeiGitH)
- **Date**
