...
- **UIView**:
  ...
  - Added `applyGradient(colors:locations:direction:)` extension to apply gradient color by [Andy0570](https://github.com/Andy0570)
- **UIImage**
...
- **UIImage**
    -  Updated `init(color: size:)` to add a default value for the `size` parameter.
