...
### Added
- **Measurement**
  - Added `+=`, `-=`, `*=`, `/=` to increase, decrease, multiply and divide measurements. [#1162](https://github.com/SwifterSwift/SwifterSwift/pull/1162) by [Roman Podymov](https://github.com/RomanPodymov)
