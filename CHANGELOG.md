...
- **CoreLocation**:
  ...
  - Added `isInRange(of:radius:unit:=.meters)` function [#1095](https://github.com/SwifterSwift/SwifterSwift/pull/1095) by [never-better](https://github.com/never-better)
- **Decodable**:
