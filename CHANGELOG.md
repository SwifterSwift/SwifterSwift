...
- **SwifterSwift**:
  - Added `withExtendedLifetime(_,_)` for ensuring that an object isn't destroyed during it's execution. [#559](https://github.com/SwifterSwift/SwifterSwift/pull/559) by [viktart](https://github.com/viktart)
