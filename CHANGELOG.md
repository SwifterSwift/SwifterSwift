...
### Added
- **Array**:
    - Added `removeDuplicates(keyPath:)` for removing duplicate elements based on key path. [#710](https://github.com/SwifterSwift/SwifterSwift/pull/710) by [Ilya Glushchuk](https://github.com/iglushchuk).
- **Color**:
